...
export default async function TraineeCourseFeedbackPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/trainee/training" className="p-2 hover:bg-slate-100 rounded-full transition-colors">
      ...
      <h2 className="text-lg font-bold mb-4">What Trainees Are Saying</h2>
      {feedbacks.length === 0 ? (
